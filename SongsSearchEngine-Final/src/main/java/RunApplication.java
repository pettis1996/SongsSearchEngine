...
public class RunApplication {
    ...
    public static void main(String[] args) throws IOException, ParseException {
         ...
         *    TODO: highlight query words in results - ** DONE ** but only for first occurrence. infinite loop (?)
        ...
        appPanel.setBackground(new Color(0x333333));
        ...
        JLabel addFilterLabel = new JLabel("Sort by Field:");

        JTextField addFilterField = new JTextField();

        JButton addFilterButton = new JButton("Sort Field");
        ...
        searchButton.addActionListener(e -> {
            ...
            try {
                ...
                Searcher searcher = new Searcher(indexDirectory[0]);
                resultDocument = searcher.search(querySearchField.getText(), fieldSearchField.getText());
            ...
            // for incrementing query counters for history
            // historyItems is displayed on ui
        ...
        resultsList.addListSelectionListener(e -> {
            ...
            while (!e.getValueIsAdjusting()){
                ...
                try {
                    textArea.getHighlighter().addHighlight(textArea.getText().indexOf(querySearchField.getText()), textArea.getText().indexOf(querySearchField.getText()) + querySearchField.getText().length(), new DefaultHighlighter.DefaultHighlightPainter(Color.green));
